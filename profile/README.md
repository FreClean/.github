...
| Repo | What it is |
|---|---|
| [`freclean-website`](../freclean-website) | Public marketing website |
| [`freclean-api`](../freclean-api) | Backend API |
| [`freclean-admin`](../freclean-admin) | Internal staff dashboard |
| [`freclean-dapp`](../freclean-dapp) | Web3 payment interface |
| [`freclean-payment`](../freclean-payment) | Payment abstraction layer & Celo verification |
| [`freclean-products`](../freclean-products) | Product catalog data and validation |
| [`freclean-operations`](../freclean-operations) | Operational workflows and checklists |
| [`freclean-entrepreneurship`](../freclean-entrepreneurship) | Entrepreneur Program documentation |
| [`freclean-docs`](../freclean-docs) | Whitepaper and roadmap |
| [`freclean-brand`](../freclean-brand) | Brand system and templates |
...
freclean7@gmail.com · +1 (849) 388-1969 · Léogâne, Ouest, Haiti
